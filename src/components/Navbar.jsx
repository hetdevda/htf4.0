    ...
    return (
      <div className='w-full h-20 flex items-center justify-between px-20'>
        ...
        <div className='flex gap-16 items-center justify-center'>
          <NavLink exact to="/mint" className="text-black text-xl no-underline hover:font-semibold active:font-semibold">Mint</NavLink>
          <NavLink exact to="/buy" className="text-black text-xl no-underline hover:font-semibold active:font-semibold">Buy</NavLink>
          <NavLink exact to="/sell" className="text-black text-xl no-underline hover:font-semibold">Sell</NavLink>
        </div>
        <div>
          <button
